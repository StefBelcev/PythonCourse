...
# 7
# Sample output
# ['D2: Disk 2', 'D1: Disk 1', 'D2: Disk 3', 'D1: Disk 1', 'D2: Disk 2', 'L1: Disk 3',
# 'D2: Disk 1', 'D2: Disk 1', 'D1: Disk 3']
...
def tuple_disks(list_disks, move_disk, indeks, value):
    temp_list = list_disks[:]
    if move_disk in temp_list:
        temp_list[indeks + value] = move_disk
        temp_list[indeks] = 0
            ...
            if start_disks[i] != 0:
                ...
                if i == 0:
                    ...
                    if start_disks[i + 1] == 0:  # + 1
                        index = i
                        value = start_disks[i]
                        new_start_disks = tuple_disks(start_disks, value, index, 1)
                        successors[f'D1: Disk {start_disks[i]}'] = (new_start_disks, end_disks)

                    elif start_disks[i + 1] != 0:  # +2
                        index = i
                        value = start_disks[i]
                        new_start_disks = tuple_disks(start_disks, value, index, 2)
