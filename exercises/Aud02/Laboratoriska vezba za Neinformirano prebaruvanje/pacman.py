...
class Pacman(Problem):
    ...
    def successor(self, state):
        ...
        if side == 'istok':
            if man_x < maximum_x - 1 and [man_x, man_y] != [man_x + 1, man_y] and [man_x + 1, man_y] not in self.obstacle_list:
                temp_dots = []
                dots_list_temp = []
                for d_x, d_y in dots:
            ...
            if man_y < maximum_y - 1 and [man_x, man_y] != [man_x, man_y + 1] and [man_x, man_y + 1] not in self.obstacle_list:
                temp_dots = []
                dots_list_temp = []
                for d_x, d_y in dots:
                    dots_list_temp.append([d_x, d_y])
