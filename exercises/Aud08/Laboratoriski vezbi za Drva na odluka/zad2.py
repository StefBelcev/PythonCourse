...
if __name__ == '__main__':
    ...
    classifier = RandomForestClassifier(random_state=0, n_estimators=n_trees, criterion=criterion_type)
    ...
    # predicted class
    print(" ".join(map(str, classifier.predict([entry]))))

    # probabilities
    print(" ".join(map(str, classifier.predict_proba([entry]))))
